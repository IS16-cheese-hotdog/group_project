...
<head>
    ...
    <style>
        body {
            ...
            background-color: #e6f7ff; /* ベースカラー */
            margin: 0;
            padding: 0;
        }
        .container {
