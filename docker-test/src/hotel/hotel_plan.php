...
<head>
    ...
    <style>
        ...
        .add-button {
            display: block;
            margin: 20px auto;
            padding: 12px 20px;  /* 縦のパディングを調整 */
            background: #007bff; /* ブルー */
            color: #fff;
            text-align: center;
            text-decoration: none;
            border-radius: 8px;
            font-size: 16px;  /* フォントサイズを少し大きく */
            width: 200px; /* 横幅を固定にして大きすぎないように調整 */
            max-width: 100%; /* 最大幅は画面に合わせて伸びる */
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
        }
        .add-button:hover {
            background: #0056b3; /* ホバー時に濃いブルー */
        }
        .back-button {
            position: absolute;
            top: 20px;
